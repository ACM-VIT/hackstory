				...
				>
					...
					{array.map((el) => {
						return (
							<div
								key={el}
								className="absolute top-0 flex h-[14vh] items-center justify-center gap-x-28 whitespace-nowrap bg-logo px-10 max-lg:h-[8vh]"
							>
								<div
									className={`flex h-[100%] w-full items-center justify-around bg-logo text-4xl font-extrabold text-marquee max-lg:text-2xl ${oswald.className}`}
								>
									FOR YOURS TO BUILD
								</div>
								<svg

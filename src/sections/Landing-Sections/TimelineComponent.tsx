      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="pt-5 text-left text-xs font-medium text-[#E8E8EE] sm:text-base">
              Welcome to HackStory. Meet your competitors, roll up your sleeves
              and get ready to come up with revolutionising ideas.
            </p>
          </motion.div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="pt-5 text-left text-xs font-medium text-[#E8E8EE] sm:text-base">
              Financial schemes seem daunting? Having monetary troubles? Bulls
              and Bears will make it easier for you.
            </p>
          </motion.div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="pt-5 text-left text-xs font-medium text-[#E8E8EE] sm:text-base">
              Choose a track and start ideating, we&apos;ll come by to take a
              look at your innovative ideas.
            </p>
          </motion.div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="pt-5 text-left text-xs font-medium text-[#E8E8EE] sm:text-base">
              Have a groundbreaking product or startup idea but don&apos; know
              how to go ahead with it? Learn it from our experienced speakers.
            </p>
          </motion.div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="pt-5 text-left text-xs font-medium text-[#E8E8EE] sm:text-base">
              Is your coding game on? In this review we’ll check the uniqueness,
              individuality and progress of your project.
            </p>
          </motion.div>
        </motion.div>
        {/* <motion.div
        ...
        >
          ...
          >
            ...
            <p className="pt-5 text-left text-xs font-medium text-[#E8E8EE] sm:text-base">
              Tech and design skills will only get you this far. Polish your
              pitching skills to win exciting prizes.
            </p>
          </motion.div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="pt-5 text-left text-xs font-medium text-[#E8E8EE] sm:text-base">
              Nothing less than a roll coaster ride, HackStory {"'23"} comes to
              an end. Take a well-deserved rest while awaiting the results.
            </p>
          </motion.div>
        </motion.div>
      </div>

...
function Clock() {
	...
	return (
		<div className="mb-[10vh] mt-[10vh] flex h-full items-center justify-center">
			<div className="flex h-full w-4/5 items-center justify-center gap-y-6 rounded-2xl bg-[#2E2E2E] sm:p-[10vh] p-[4vh] max-lg:flex-col max-lg:py-[5vh]">
				<div className="sm:text-2xl text-xl font-bold text-[#FFF6E8] max-lg:text-center lg:w-3/5 lg:mr-16">
					<p>
				...
				<div className="items-center justify-center rounded-2xl border border-[#A7A9BE] p-6 text-center text-xl sm:text-2xl font-bold text-[#A7A9BE]  lg:p-12">

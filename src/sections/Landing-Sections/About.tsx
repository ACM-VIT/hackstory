...
const About = () => {
  return (
    <div className=" mt-9 flex w-full flex-col items-center justify-center gap-20  md:gap-28 lg:gap-20">
      ...
      >
        <text>
          FUELED BY <span className="text-[#FFCCDE]">INNOVATION</span>,
        </text>
        <text>
          EMPOWERED BY <span className="text-yellow">DISCOURSE</span>,
        </text>
        <text>
          HOOKED BY <span className="text-[#FFCCDE]">SKILLS</span>,
        </text>
        <text>
          STIRRED BY <span className="text-yellow">PASSION</span> AND
        </text>
        <text>

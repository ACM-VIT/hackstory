        ...
        <>
            ...
            <div className='mt-[5rem]'>
                {tracks.map((track,index)=>(
                    <div key={index} className='ml-[20rem] mr-[20rem] border-b border-tracks flex flex-col pb-8 pt-4 gap-y-8 mb-10'>
                        <p className={`text-tracks text-3xl font-extrabold ${oswald.className}`}>{track}</p>
